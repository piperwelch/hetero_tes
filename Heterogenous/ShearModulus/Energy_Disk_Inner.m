function [Eval, Fval] = Energy_Disk_Inner(xy_all, N, Nvoxel, Nvert, D_all, L0, Wlist, linklist_inner, Kw)
%%
...
for it = 1:size(linklist_inner, 1)
    idx1 = linklist_inner(it, 1);
    idx2 = linklist_inner(it, 2);
    lx = xc(idx2) - xc(idx1);
    ly = yc(idx2) - yc(idx1);
    lk = sqrt(lx^2 + ly^2);
