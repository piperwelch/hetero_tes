function [sigma_all_shear, sigma_p_shear, sigma_w_shear, Fext_all, gamma_all, G_all, xy_t] = ...
                        ShearModulus_Strain(xy_all, L0, N, D_all, Kp, Kw_ratio, Kpw_ratio, dgamma, theta)
%%
Np_tot = 2 * N;
...
[sigma_all, sigma_p, sigma_w] = StressTensorAll_CL(xy_t(:, 1), L0, N, D_all, Kpw, Kw, CL_pw);
...
[~, Fval] = Energy_Disk_All_CL(xy_new, xc, yc, L0, N, D_all, Kp, Kpw, Kw, CL_pp, CL_pw);
...
%              0, 1];
    ...
    [sigma_all, sigma_p, sigma_w] = StressTensorAll_CL(xy_t(:, it + 1), L0, N, D_all, Kpw, Kw, CL_pw);
...
%     sigma_tensor_all(it, :) = reshape(sigma_tensor, 1, 4);
    [~, Fval] = Energy_Disk_All_CL(xy_new, xc_strain, yc_strain, L0, N, D_all, Kp, Kpw, Kw, CL_pp, CL_pw);
...
G_all = -[G_fit_tot(1); G_fit_p(1); G_fit_w(1)];